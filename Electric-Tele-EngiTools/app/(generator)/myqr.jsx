    ...
    <SafeAreaView className="bg-primary flex-1">
      <ScrollView contentContainerStyle={{ flexGrow: 1, justifyContent: "space-evenly", padding: 20 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="items-center mb-8 mt-10">
          ...
          <Text className="text-white text-lg text-center mt-2 font-pbold">Create QR Code of your information</Text>
          <Image source={icons.myself} style={{ width: 80, height: 80 }} className="mt-4" tintColor="#fff" resizeMode="contain" />
        </View>
